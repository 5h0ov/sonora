...
queue-return-playing = Çalana geri dön
...
settings-tab-integrations = Tümleştirmeler
settings-theme = Tema
...
settings-fullscreen-controls-autohide = Tam ekran denetimlerini gizle
settings-fullscreen-controls-autohide-detail = Tam ekranda bir süre işlem yapılmayınca çalma denetimlerini soldur
...
settings-traffic-light-controls = Trafik ışığı denetimleri
settings-traffic-light-controls-detail = Küçült, büyüt ve kapat düğmelerini renkli noktalar olarak çiz
settings-window-rounding = Pencere köşeleri
settings-window-rounding-detail = Pencerenin kendi köşelerinin ne kadar yuvarlak olduğu
...
settings-discord = Discord'da göster
settings-discord-detail = Dinlediğin parçayı Discord profilinde göster
settings-discord-name = Durum adı
settings-discord-name-detail = Arkadaşlarının gördüğü "Dinliyor" ifadesinden sonra durumun adı
settings-discord-name-sonora = Sonora
settings-discord-name-provider = Servis
settings-discord-name-music = Müzik
settings-discord-name-title = Başlık
settings-discord-name-artist = Sanatçı
settings-discord-name-artist-title = Sanatçı - Başlık
settings-discord-show-paused = Duraklatıldığında da göster
settings-discord-show-paused-detail = Parça duraklatılmışken de durumu Discord profilinde tut
settings-discord-badge = Servis rozetini göster
settings-discord-badge-detail = Durumu, parçanın geldiği servisin küçük bir simgesiyle işaretle
settings-discord-anonymous = Ayrıntıları gizle
settings-discord-anonymous-detail = Başlık, sanatçı ya da kapak olmadan yalnızca müzik çaldığını bildir
settings-discord-buttons = Düğmeler
settings-discord-buttons-detail = Durumun altında arkadaşlarının açabileceği bağlantılar: biri parçanın kendi servisine, biri Sonora'ya
settings-discord-buttons-pick = Düğmeleri seç
# the Discord status when the track is left out of it
discord-listening = Müzik dinliyor
get-sonora = Sonora'yı edin
settings-fullscreen-controls-autohide-automatic = Otomatik
settings-fullscreen-controls-autohide-always-hidden = Her zaman gizli
settings-fullscreen-controls-autohide-always-shown = Her zaman görünür
...
settings-equalizer-detail = Sesi her biri bir oktav olan on bantta biçimlendirir
settings-equalizer-preset = Hazır ayar
settings-equalizer-preset-detail = Aşağıdaki bantlar için hazır bir eğri
settings-equalizer-custom = Özel
settings-equalizer-flat = Düz
settings-equalizer-bass-boost = Bas yükseltme
settings-equalizer-bass-reducer = Bas azaltma
settings-equalizer-treble-boost = Tiz yükseltme
settings-equalizer-vocal = Vokal
settings-equalizer-rock = Rock
settings-equalizer-pop = Pop
settings-equalizer-jazz = Caz
...
settings-group-equalizer = Ekolayzer
...
nav-pins-kind = Türe göre
nav-show-full-library = Tüm kitaplığı göster
nav-return-top = Başa dön
